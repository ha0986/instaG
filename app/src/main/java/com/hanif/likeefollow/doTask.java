...
public class doTask extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reward.setOnClickListener(v->  autoLoad.loadReward(this, doTask.this, autoLoad.taskAdd, "doTask"));
        ...
        use.setOnClickListener(v->startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://youtu.be/R35ZixzaMiE"))));
    ...
    public void startTask(){
        try {
            ...
            Log.d(TAG, Arrays.toString(toSplit));
            if (toSplit.length==2){
                minusUser = toSplit[0];
                ...
                if(minusUser.contains("*")){
                    minusUser = minusUser.replace("*","/");
                    link= "https://l.likee.video/"+minusUser.trim();
                }else{
                    link="https://l.likee.video/p/"+minusUser.trim();
                }
                Intent intent = new Intent(Intent.ACTION_VIEW, Uri.parse(link));
                startActivity(intent);
            }
        }catch (Exception e){
            Toast.makeText(this, "Please check your internet permission", Toast.LENGTH_SHORT).show();
        }
